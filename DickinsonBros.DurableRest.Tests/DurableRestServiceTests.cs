...
namespace DickinsonBros.DurableRest.Tests
{
    ...
    public class DurableRestServiceTests : BaseTest
    {
        ...
        //[TestMethod]
        //public async Task ExecuteAsyncOfTz_StandardInput_RestClientFactoryCreateCalled()
        //{
        //    await RunDependencyInjectedTestAsync
        //    (
        //        async (serviceProvider) =>
        ...
        //            //            var uut = serviceProvider.GetRequiredService<ILoggingService<DurableRestService>>();
        //            //var uut = serviceProvider.GetRequiredService<ILoggingService<DurableRestService>>();
        ...
        //            //            var accountDBServiceMock = serviceProvider.GetMock<ILoggingService<DurableRestService>();
